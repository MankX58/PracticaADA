...
Los datos de la red vial provienen del dataset masivo `calles_de_medellin_con_acoso.csv`, el cual contiene toda la planimetría de calles con su longitud y riesgo.
