...
|---|---|---|
| **Temporal** | **O(N log N)** | Donde N es el número de nodos. Cada nodo se extrae del heap en tiempo log N. |
| **Espacial** | **O(N)** | Almacenar la lista de adyacencia (es proporcional a los nodos en grafos dispersos), distancias, predecesores y la cola. |
...
|---|---|---|
| **Temporal** | O(N log N) | Mejor que Dijkstra (menos nodos explorados) |
| **Espacial** | O(N) | Similar a Dijkstra |
